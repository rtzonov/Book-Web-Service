...
<html>
<head>
    <link rel="stylesheet" href="<c:url value="/css/payment.css"/>" type="text/css">
    ...
    .st0 {
		...
		c40.9,0,74.1,33.2,74.1,74.1v222.2C382.8,342.1,349.7,375.3,308.8,375.3z"/>
                ...
                <div class="Card-number">
                    <h4 style="margin-bottom: 32px;">Номер карточки:</h4>
                    <ul>
                        <li id="first-lis_deletedi" style="text-align: left"><input id="card_number"
                                                                                    style="margin-right: 200px; width: 47.5%; height: 32px;"
                                                                                    type="number" pattern="[0-9]{16}$"
                                                                                    title="пример: 1234123412341234"
                                                                                    required></li>
                    </ul>
                </div>
                ...
                <div class='Expire'>
                    <h4>Годна до:</h4>
                    <p><input style="width: 100px; height: 32px; font-size: 16px;" type="date" required></p>
                </div>

                <div class='Name'>
                    <h4>Имя владельца:</h4>
                    <input style="width: 70%; height: 32px;" type="text" pattern="[a-zA-Zа-яёА-ЯЁ ]{2,30}"
                           title="пример: ИВАН ИВАНОВ" required>
                </div>
...
<div style="text-align: center; margin-top: 25px;">
    <a href="#demo-modal"
       style="margin-top: 15px; font-size: 20px; text-decoration: none; padding: 10px; background-color: lawngreen; border-style: none; color: black">
        Оплатить
    </a>
</div>
</form>
    ...
    <div class="modal__content">
        <form action="/book/menu" method="get" style="text-align: center">
            <label>
                ...
                <button type="submit"
                        style="margin-top: 25px; margin-bottom: 10px; padding: 10px; background-color: mintcream; border-style: none; color: black">
