...
public interface AuthorService {
    ...
    Author edit(Integer id, String name, String lastName); //при изменении книги админу
    ...
    Boolean exists(Author author); //проверить есть ли такой в списке чтоб при добавлении не содавать такого же , админу
}
